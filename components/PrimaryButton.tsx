...
export function PrimaryButton({
  ...
  const base =
    "type-btn relative isolate flex h-fit cursor-pointer select-none items-center justify-center gap-2.5 overflow-hidden rounded-full text-center font-sans uppercase antialiased transition-[border-color,background,box-shadow,transform,color] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#030504] motion-reduce:transition-colors motion-reduce:hover:translate-y-0 motion-reduce:active:translate-y-0";
